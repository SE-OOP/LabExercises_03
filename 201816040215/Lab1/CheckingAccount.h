...
public:
   ...
   CheckingAccount( double balance,double transacrionFee )/* Declare a two-argument constructor for CheckingAccount */

   double credit();/* Redeclare member function credit, which will be redefined */
   double debit();/* Redeclare member function debit, which will be redefined */
private:
