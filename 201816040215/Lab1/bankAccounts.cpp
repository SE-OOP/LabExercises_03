...
int main()
{
   ...
   cout << "\naccount2 rate: $" << account2.calculateInterest() << endl;/* Declare a variable interestEarned and assign it the interest
      account2 should earn */
   cout << "\nAdding $" << interestEarned << " interest to account2."
      << endl;
   cout << "\naccount2 balance: $" << account2.getbalance() << endl;/* Write a statement to credit the interest to account2's balance */
