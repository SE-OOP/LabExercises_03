...
SavingsAccount::SavingsAccount( double balance = 0.0,double rate = 0.0 )/* Write the SavingsAccount constructor to call the Account constructor
   and validate and set the interest rate value */

// return the amount of interest earned
double calculateInterest()
{
    return balabce * ( 1+ rate );
