...
{
   get lastName;/* Call commissionEmployee's getLastName function */
...
{
   get socialSecurityNumber;/* Call commissionEmployee's getSocialSecurity function */
...
{
   get grossSales;/* Call commissionEmployee's getGrossSales function */
...
{
   get commissionRate;/* Call commissionEmployee's getCommissionRate function */
...
void BasePlusCommissionEmployee::print() const
{
   ...
   BasePlusCommissionEmployee.print();/* Call commissionEmployee's print function */
