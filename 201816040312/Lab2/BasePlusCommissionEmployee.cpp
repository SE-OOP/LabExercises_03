...
BasePlusCommissionEmployee::BasePlusCommissionEmployee(
   ...
   : employee1(first,last,ssn,sales,rate)
...
void BasePlusCommissionEmployee::setSocialSecurityNumber(
   const string &ssn )
{
    employee1.setSocialSecurityNumber(ssn);
...
{
    return employee1.getSocialSecurityNumber();
...
{
    return employee1.getGrossSales();
...
{
    employee1.setCommissionRate(rate);
...
{
    return employee1.getCommissionRate();
