...
{
   setFirstName(first); // should validate
   setLastName(last);   // should validate
...
{
   cout << "commission employee: " << CommissionEmployee::getFirstName() << ' ' << CommissionEmployee::getLastName()
