...
public:
   ...
   void credit ( double );//credit for class CheckingAccount
   /* Redeclare member function debit, which will be redefined */
   bool debit ( double );//debit for class CheckingAccount
private:
   /* Declare data member transactionFee */
   double transactionFee;//transaction Fee for Checking Account

   // utility function to charge fee
   /* Declare member function chargeFee */
   void chargeFee();//function charge fee for Checking Fee
