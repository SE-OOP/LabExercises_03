...
//≥ı ºªØcommonemployee ˝æ›≥…‘±£¨Ω´(first, last, ssn, sales, rate)¥´µ›∏¯À¸µƒππ‘Ï∫Ø ˝
    :n(first, last, ssn, sales, rate)
    {
...
void BasePlusCommissionEmployee::setFirstName( const string &first )
{
   /* Call commissionEmployee's setFirstName function */
    //µ˜”√commonemployeeµƒsetFirstName∫Ø ˝
...
string BasePlusCommissionEmployee::getFirstName() const
{
   /* Call commissionEmployee's getFirstName function */
    //µ˜”√commissionEmployeeµƒgetFirstName∫Ø ˝
...
string BasePlusCommissionEmployee::getSocialSecurityNumber() const
{
   /* Call commissionEmployee's getSocialSecurity function */
    return n.getSocialSecurityNumber();
...
double BasePlusCommissionEmployee::earnings() const
{
    //return getBaseSalary() + ;
      ...
      //µ˜”√commissionEmployeµƒearningπ¶ƒ‹∫Ø ˝
      return n.earnings();
