...
BasePlusCommissionEmployee::BasePlusCommissionEmployee(
   ...
   : /* Initialize the commissionEmployee data member,
	    ...
	    people(first,last,ssn,sales,rate)//initialize CommissionEmployee data member
{
...
void BasePlusCommissionEmployee::setFirstName( const string &first )
{
   ...
   people.setFirstName(first);//Commission'function
...
{
    return people.getFirstName();//Commission'function
...
{
    people.setLastName(last);//Commission'function
...
{
    return people.getLastName();//Commission'function
...
void BasePlusCommissionEmployee::setSocialSecurityNumber(
   const string &ssn )
{
    people.setSocialSecurityNumber(ssn);//Commission'function
...
{
    return people.getSocialSecurityNumber();//Commission'function
...
{
    people.setGrossSales(sales);//Commission'function
...
{
    return people.getGrossSales();//Commission'function
...
{
    people.setCommissionRate( rate );//Commission'function
...
{
    return people.getCommissionRate(  );//Commission'function
...
{
   return getBaseSalary() +people.getCommissionRate()*people.getGrossSales();
...
people.print();//Commission'function
