...
BasePlusCommissionEmployee::BasePlusCommissionEmployee(
   ...
   : m_ce(first, last, ssn, sales, rate)
   ...
   const string &ssn )
{
   ...
   m_ce.setSocialSecurityNumber(ssn);
...
string BasePlusCommissionEmployee::getSocialSecurityNumber() const
{
   ...
   return m_ce.getSocialSecurityNumber();
...
{
   return getBaseSalary() + m_ce.earnings();
