...
CheckingAccount::CheckingAccount(double mo,double fee)
:Account(mo)
{
   transactionFee = fee;
}
...
void CheckingAccount::credit( double mo )
{
       this->Account::credit(mo);
       this->chargeFee();
}
...
void CheckingAccount::debit( double mo )
{
      if( this->Account::debit(mo))
        this->chargeFee();
}
...
{
   this->Account::debit(transactionFee);
