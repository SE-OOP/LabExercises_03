...
CheckingAccount::CheckingAccount( double initialBalance, double ttransactionFee )
   :Account(initialBalance)
{
   if (  ttransactionFee >= 0.0  )
   {
   ...
   {
      cout << "Error: Initial balance and transaction fee cannot be negative." << endl;
      transactionFee = 0.0;
   } // end if...else
...
void CheckingAccount::chargeFee()
{
    ...
    cout << "$" << transactionFee << " transaction fee charge." << endl;
}
