...
BasePlusCommissionEmployee::BasePlusCommissionEmployee(
   ...
   : employeeMessage(first,last,ssn,sales,rate)
{
...
{
   return getBaseSalary() + employeeMessage.earnings();
