...
int main()
{
   ...
   SavingsAccount interestEarned(2.70,1.00);

   cout << "\nAdding $" << interestEarned.calculateInterest()<< " interest to account2."<< endl;
   account2.credit(interestEarned.calculateInterest());
