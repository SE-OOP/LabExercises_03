...
void BasePlusCommissionEmployee::setSocialSecurityNumber( 
   const string &ssn )
{
   base.setSocialSecurityNumber(ssn);
...
{
   return base.getSocialSecurityNumber();
...
{
   return getBaseSalary() + base.earnings();
