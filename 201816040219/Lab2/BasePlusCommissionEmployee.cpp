...
void BasePlusCommissionEmployee::print() const
{
   ...
   cout<<Employee.getFirstName()<<" "<<Employee.getLastName()<<endl;
   cout<<"social security number:"<<Employee.getSocialSecurityNumber()<<endl;
   cout<<"gross sales:"<<Employee.getGrossSales()<<endl;
   cout<<"commission rate:"<<Employee.getCommissionRate();
