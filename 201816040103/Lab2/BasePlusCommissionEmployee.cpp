...
{
   cout << "base-salaried ";
   cout << "commission employee: " << a.getFirstName() << ' ' << a.getLastName()
      << "\nsocial security number: " << a.getSocialSecurityNumber()     
      << "\ngross sales: " << a.getGrossSales()                         
      << "\ncommission rate: " << a.getCommissionRate(); 
