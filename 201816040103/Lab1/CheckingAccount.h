...
{
public:
   CheckingAccount(double,double);// constructor initializes balance and transaction fee
   void setTransaction(double);/* Declare a two-argument constructor for CheckingAccount */
