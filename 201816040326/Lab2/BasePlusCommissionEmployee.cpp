...
BasePlusCommissionEmployee::BasePlusCommissionEmployee(
   ...
   // initialize composed object
    /* Initialize the commissionEmployee data member,
	    ...
	    :com1(first,last,ssn,sales,rate)
{
   ...
   const string &ssn )
{
   ...
   com1.setSocialSecurityNumber(ssn);
...
string BasePlusCommissionEmployee::getSocialSecurityNumber() const
{
   ...
   return com1.getSocialSecurityNumber();
...
{
   return getBaseSalary() + com1.earnings();
