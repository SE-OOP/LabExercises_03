...
BasePlusCommissionEmployee::BasePlusCommissionEmployee(
   ...
   : /* Initialize the commissionEmployee data member,
	    ...
	    employ(first,last,ssn,sales,rate)
{
   ...
   const string &ssn )
{
   ...
   employ.setSocialSecurityNumber(ssn);
...
string BasePlusCommissionEmployee::getSocialSecurityNumber() const
{
   /* Call commissionEmployee's getSocialSecurity function */
    return employ.getSocialSecurityNumber();
...
double BasePlusCommissionEmployee::getCommissionRate() const
{
   ...
   return employ.getCommissionRate();
...
{
   return getBaseSalary() + employ.earnings();
